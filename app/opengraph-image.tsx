    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 28, marginBottom: 36 }}>
        ...
        >
          ...
          >
            <div style={{ width: 12, height: 20, borderRadius: 3, background: "#AEB9C4" }} />
            <div style={{ width: 12, height: 28, borderRadius: 3, background: "#EEF2F5" }} />
            <div style={{ width: 12, height: 36, borderRadius: 3, background: "#F0B15C" }} />
          </div>
        </div>
